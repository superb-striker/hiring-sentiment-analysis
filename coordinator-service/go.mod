module hiring-sentiment/coordinator
...
require (
	...
	hiring-sentiment/hiringdb v0.0.0
	hiring-sentiment/shared v0.0.0
)
...
replace hiring-sentiment/shared => ../shared

replace hiring-sentiment/hiringdb => ../hiringdb
